...
// Note that DEBUGND is particularly noisy - you will see all calls on behalf of RHIB and Rowboat.
...
{
    [Info("CupboardNoDecay", "RFC1920", "1.0.8", ResourceId = 2341)]
